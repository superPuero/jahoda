...
typedef struct
{
	...
	arena pfif_arenas[jahoda_vk_frames_in_flight];

	gpu_arena pfif_hc_buf_arenas[jahoda_vk_frames_in_flight];
	gpu_arena sw_hc_buf_arenas[jahoda_vk_frames_in_flight];
	gpu_arena sw_dl_img_arenas[jahoda_vk_frames_in_flight]; 
	gpu_arena st_dl_img_arenas[jahoda_vk_frames_in_flight]; 	
} gpu_context;	
